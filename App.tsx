          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
            ...
            <div className="inline-flex bg-gray-100 p-1.5 rounded-2xl border border-gray-300 shadow-inner">
              <button
                ...
                className={`px-6 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 ${viewMode === ViewMode.MONTHLY
              ...
              <button
                ...
                className={`px-6 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 flex items-center gap-2 ${viewMode === ViewMode.FULL
